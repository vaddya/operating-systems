...
int main(int argc, char* argv[])
{
	...
	//num = 31; // не комментируем для real-time
...
HANDLE initTimer(int sec) {
	...
	wchar_t wTimer[5];
	mbstowcs(wTimer, "timer", 5);
	HANDLE tm = CreateWaitableTimer(NULL, false, wTimer);
