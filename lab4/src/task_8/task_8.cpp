...
int main(int argc, char *argv[]) {
    ...
    secondThread = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE) thread, NULL, 0, &secondID);
    //print default values
    cout << "0 - dynamic enabled, 1 - disabled." << endl;
    ...
    if (!SetThreadPriorityBoost(secondThread, true)) { //disable
    ...
    if (!SetThreadPriorityBoost(secondThread, false)) { //disable
